export default {
    ...
    getters: {
        ...
        numDietaryRestrictions(_, _2, _3, rootGetters) {
            return rootGetters['personalInfo/restrictions'].dietary.restrictionItems.length;
        },
        currentMonthMoneySpent(_1, _2, _3, rootGetters) {
            const groceriesTotal = rootGetters['budget/budgets'].groceries.stats.currentTotal;
            const diningOutTotal = rootGetters['budget/budgets'].diningOut.stats.currentTotal;
