<template>
	<dashboard-layout>
		<div class="grocery-list-container" >
            ...
            <base-modal v-show="exportModalVisible" @close="closeModal" id="export-modal-container">
				...
				<template v-slot:body>
					<form @submit.prevent="submitExport">
						...
						<select name="download-option" id="download-option" v-model="downloadOption">
			...
			<div class="grocery-list-form-container" v-else>
                <form class="grocery-list-form">
                    <div class="ingredient-container" v-for="ingredient in uniqueIngredients" :key="ingredient">
                        ...
                        <label v-if="counts[ingredient] === 1" :class="{ 'checked-input': isChecked[ingredient] }">{{ ingredient }}</label>
                        <label v-else-if="counts[ingredient] > 1" :class="{ 'checked-input': isChecked[ingredient] }">
